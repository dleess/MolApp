...
**Availability and implementation:** MolApp is written in Swift/SwiftUI for iPadOS 18 or later and builds with Xcode against bundled, offline Mol\* assets. Source code is available at https://github.com/deepnmr/MolApp *[license to be specified]*.
